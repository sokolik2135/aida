...
<head>
    ...
    <title>Aida - Dein persönlicher Assistent!</title>
...
<body>
    ...
    <main>
        <div id="header">
            <h1>Hallo, ich bin Aida</h1>
        </div>
        <h1 style="font-size:60px;display:inline-flex;align-items:center;">Geduld, die Seite bald auf Deutsch!</h1>
    </main>
    <footer>
